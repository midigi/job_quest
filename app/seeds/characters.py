...
def seed_characters():
    ...
    demoChar2 = Character(user=demo, pic_url='https://webstockreview.net/images/clipart-student-female-15.png', location_id=1, name="Sarah", stamina=1, mental_health=1, wisdom=1, intelligence=1)

    db.session.add(demoChar)
    db.session.add(demoChar2)
